...
/**
 * CPE Handler con Navegación por Fases (v4.5)
 * 100% fiel a consultas/cpeScrapingHandler.js con todas las fases de autenticación,
 * navegación a menú de token, portal Angular, extracción de modal y descompresión de ZIP (XML + CDR) en memoria.
 */
class CpeHandler {
  constructor() {
   ...
   * Captura XML/CDR con descompresión rápida en memoria y datos completos para el visor vectorial.
   */
    ...
    for (let i = 0; i < facturas.length; i++) {
      ...
      try {
        ...
        if (resultado.encontrado) {
          // Descargar el paquete oficial de SUNAT (ZIP o XML)
          ...
          if (downloadedFile && fs.existsSync(downloadedFile)) {
            try {
              // Intentar descomprimir si es ZIP (contiene la factura XML y el CDR XML)
              ...
              // Si no era ZIP sino XML directo
