...
const App: React.FC = () => {
  ...
  return (
    <div className={`h-screen w-screen flex flex-col overflow-hidden bg-app-bg text-app-text font-sans selection:bg-blue-600 selection:text-white transition-colors duration-200 ease-in-out ${theme === 'dark' ? 'dark' : ''}`}>
