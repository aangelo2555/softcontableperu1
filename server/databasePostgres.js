...
const db = {
    ...
    // Siempre devuelve una función (thunk) que se debe invocar: await db.transaction(cb)()
    // o: const tx = db.transaction(cb); await tx(data);
...
async function ensureSchemaConstraints() {
    try {
            ...
            },
            {
                ...
                schema: `
                    CREATE TABLE IF NOT EXISTS employees (
                        ...
                        sueldo_basico NUMERIC DEFAULT 0,
                        fecha_nacimiento TEXT,
                        edad NUMERIC DEFAULT 0,
                        fecha_ingreso TEXT,
                        fecha_salida TEXT,
                        ...
                        jornal_diario NUMERIC DEFAULT 0,
                        asignacion_familiar BOOLEAN DEFAULT FALSE,
                        asignacion_familiar_monto NUMERIC DEFAULT 0,
                        horas_extras_cantidad NUMERIC DEFAULT 0,
                        horas_extras_importe NUMERIC DEFAULT 0,
                        total_remuneracion NUMERIC DEFAULT 0,
                        descuento_onp NUMERIC DEFAULT 0,
                        essalud_vida NUMERIC DEFAULT 0,
                        impuesto_renta_5ta NUMERIC DEFAULT 0,
                        retencion_judicial NUMERIC DEFAULT 0,
                        afp_fondo NUMERIC DEFAULT 0,
                        afp_seguro NUMERIC DEFAULT 0,
                        afp_comision NUMERIC DEFAULT 0,
                        total_descuento NUMERIC DEFAULT 0,
                        neto_pagar NUMERIC DEFAULT 0,
                        essalud_empleador NUMERIC DEFAULT 0,
                        sctr_empleador NUMERIC DEFAULT 0,
                        user_id TEXT NOT NULL
                    );
        ...
        const alterStatements = [
            ...
            `ALTER TABLE public.employees ADD COLUMN IF NOT EXISTS nombre TEXT;`,
            `ALTER TABLE public.employees ADD COLUMN IF NOT EXISTS fecha_nacimiento TEXT;`,
            `ALTER TABLE public.employees ADD COLUMN IF NOT EXISTS edad NUMERIC DEFAULT 0;`,
            `ALTER TABLE public.employees ADD COLUMN IF NOT EXISTS puesto TEXT;`,
            `ALTER TABLE public.employees ADD COLUMN IF NOT EXISTS fecha_salida TEXT;`,
            `ALTER TABLE public.employees ADD COLUMN IF NOT EXISTS fecha_reingreso TEXT;`,
            `ALTER TABLE public.employees ADD COLUMN IF NOT EXISTS regimen_pensionario TEXT;`,
            `ALTER TABLE public.employees ADD COLUMN IF NOT EXISTS cussp TEXT;`,
            `ALTER TABLE public.employees ADD COLUMN IF NOT EXISTS dias_trabajados NUMERIC DEFAULT 30;`,
            `ALTER TABLE public.employees ADD COLUMN IF NOT EXISTS jornal_diario NUMERIC DEFAULT 0;`,
            `ALTER TABLE public.employees ADD COLUMN IF NOT EXISTS sueldo_basico NUMERIC DEFAULT 0;`,
            `ALTER TABLE public.employees ADD COLUMN IF NOT EXISTS asignacion_familiar_monto NUMERIC DEFAULT 0;`,
            `ALTER TABLE public.employees ADD COLUMN IF NOT EXISTS horas_extras_cantidad NUMERIC DEFAULT 0;`,
            `ALTER TABLE public.employees ADD COLUMN IF NOT EXISTS horas_extras_importe NUMERIC DEFAULT 0;`,
            `ALTER TABLE public.employees ADD COLUMN IF NOT EXISTS total_remuneracion NUMERIC DEFAULT 0;`,
            `ALTER TABLE public.employees ADD COLUMN IF NOT EXISTS descuento_onp NUMERIC DEFAULT 0;`,
            `ALTER TABLE public.employees ADD COLUMN IF NOT EXISTS essalud_vida NUMERIC DEFAULT 0;`,
            `ALTER TABLE public.employees ADD COLUMN IF NOT EXISTS impuesto_renta_5ta NUMERIC DEFAULT 0;`,
            `ALTER TABLE public.employees ADD COLUMN IF NOT EXISTS retencion_judicial NUMERIC DEFAULT 0;`,
            `ALTER TABLE public.employees ADD COLUMN IF NOT EXISTS afp_fondo NUMERIC DEFAULT 0;`,
            `ALTER TABLE public.employees ADD COLUMN IF NOT EXISTS afp_seguro NUMERIC DEFAULT 0;`,
